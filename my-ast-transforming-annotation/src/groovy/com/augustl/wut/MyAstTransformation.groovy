...
class MyAstTransformation implements ASTTransformation {
    ...
    void visit(ASTNode[] nodes, SourceUnit source) {
        ...
        FieldNode aField = method.declaringClass.fields.find { it.name == "grailsApplication"}
        if (!aField) {
            throw new RuntimeException("Expected to find the field 'grailsApplication'")
        }
        ...
        ExpressionStatement contextAssignmentExpression = new ExpressionStatement(
            new DeclarationExpression(
                ...
                new MethodCallExpression(
                    new VariableExpression(aField.name),
                    "getConfig",
